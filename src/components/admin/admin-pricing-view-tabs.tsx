 ...
 * 작업비 난이도 정액표(labor_tier_catalog) — 서로 다른 테이블이지만 전부 "가격 정책" 성격이라
 * 화면 3개로 흩어져 있던 것을 /admin/pricing 하나의 탭으로 합침.
 */
export default function AdminPricingViewTabs({ initialMaterials, initialLaborTiers, initialView }: Props) {
