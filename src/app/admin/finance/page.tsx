...
export default async function FinanceAdminPage() {
  if (!isSupabaseReservationsDbReady()) {
    return (
      <main className="page-fit max-w-6xl space-y-6">
        <AdminPageHeader title="금융/계좌 관리" description="Supabase DB 모드에서 입금·환불 관제를 사용할 수 있습니다." />
  ...
  return (
    <main className="page-fit max-w-6xl space-y-6">
      <AdminPageHeader title="금융/계좌 관리" description="입금·계좌 모니터링, 수동환불 추적과 사업자 주계좌(고객 입금 안내)를 관리합니다." />
