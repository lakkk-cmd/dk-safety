...
export default async function ApartmentSimpleSwapPage({ params }: { params: Promise<{ code: string }> }) {
  ...
  return <ServiceRequestPage apartment={apartment} requestType="simple-swap" simpleSwapFee={paymentSettings.simpleSwapFee} />;
}
